...
import { zmkAllSlotNames, zmkApplySlotNames } from './zmk.js?v=39';
import { encodeComboSlot, decodeComboSlot, COMBO_MAX_KEYS,
         ...
         comboTypedToLegacy } from './zmk-combos-codec.js?v=39';
import { encodeMacroStep, decodeMacroStep } from './zmk-macros-codec.js?v=39';

...
import { zmkAllSlotNames, zmkApplySlotNames } from './zmk.js?v=40';
import { encodeComboSlot, decodeComboSlot, COMBO_MAX_KEYS,
         ...
         comboTypedToLegacy } from './zmk-combos-codec.js?v=40';
import { encodeMacroStep, decodeMacroStep } from './zmk-macros-codec.js?v=40';
import { encodeLeaderSlot, decodeLeaderSlot, encodeGestureSlot, decodeGestureSlot }
    from './zmk-output-codec.js?v=40';
import { encodeCskSlot, decodeCskSlot } from './zmk-csk-codec.js?v=40';

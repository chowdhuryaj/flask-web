...
export function capabilities(family, version) {
    ...
    const imprint = family === 'imprint';
    return {
        flask,
        // Vial surface (keymap/macros/tap-dance/combos/overrides/QMK settings):
        // every QMK device has it; the ZMK line has none — Studio + git own
        // the keymap there.
        vial: !imprint,
        // Mouse/pointing tuning.
        mouse: flask && (trackball || imprint),
        ...
        vialRGB: flask && nlkb,
        diag: flask && !imprint && v >= (nlkb ? 1 : 7),
        // HUD live layer follow (meta 0x02): trackballs v10+, NLKB16 and
        // imprint always.
        hudLayer: flask && (nlkb || imprint || v >= 10),

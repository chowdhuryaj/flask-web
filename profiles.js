...
import { VIDPID } from './flaskproto.js?v=34';
import { zmkFamilyCandidate, ZMK_FAMILY_LABELS } from './zmk.js?v=34';
import { napeFamilyCandidate, NAPE_FAMILY_LABELS } from './nape.js?v=34';

...
import { VIDPID } from './flaskproto.js?v=40';
import { zmkFamilyCandidate, ZMK_FAMILY_LABELS } from './zmk.js?v=40';
import { napeFamilyCandidate, NAPE_FAMILY_LABELS } from './nape.js?v=40';

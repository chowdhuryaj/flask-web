...
import { VIDPID } from './flaskproto.js?v=38';
import { zmkFamilyCandidate, ZMK_FAMILY_LABELS } from './zmk.js?v=38';
import { napeFamilyCandidate, NAPE_FAMILY_LABELS } from './nape.js?v=38';

...
import { VIDPID } from './flaskproto.js?v=39';
import { zmkFamilyCandidate, ZMK_FAMILY_LABELS } from './zmk.js?v=39';
import { napeFamilyCandidate, NAPE_FAMILY_LABELS } from './nape.js?v=39';

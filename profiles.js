...
import { VIDPID } from './flaskproto.js?v=41';
import { zmkFamilyCandidate, ZMK_FAMILY_LABELS } from './zmk.js?v=41';
import { napeFamilyCandidate, NAPE_FAMILY_LABELS } from './nape.js?v=41';

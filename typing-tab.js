...
import { CH, V, slot, CSK_SLOTS, LEADER_SEQS, LEADER_KEYS, osName } from './flaskproto.js?v=18';
import { capLabel, describe } from './keycodes.js?v=18';
import { buildPicker } from './picker.js?v=18';

...
import { el, card, sliderRow, toggleRow, selectRow, saveBar, toast } from './ui.js?v=2';
import { CH, V, slot, CSK_SLOTS, LEADER_SEQS, LEADER_KEYS, osName } from './flaskproto.js?v=2';
import { capLabel, describe } from './keycodes.js?v=2';
